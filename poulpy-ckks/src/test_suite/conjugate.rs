...
pub fn test_conjugate_aligned<BE: Backend, F: TestScalar, E: NegacyclicFFT<F>>(ctx: &TestContext<BE, F, E>)
where
    Module<BE>: GLWEAutomorphismDefaults<BE> + GLWEAutomorphism<BE> + GLWEShift<BE> + crate::leveled::api::CKKSConjugateOps<BE>,
...
/// Conjugation out-of-place: real part preserved, imaginary part negated.
pub fn test_conjugate_smaller_output<BE: Backend, F: TestScalar, E: NegacyclicFFT<F>>(ctx: &TestContext<BE, F, E>)
where
    Module<BE>: GLWEAutomorphismDefaults<BE> + GLWEAutomorphism<BE> + GLWEShift<BE> + crate::leveled::api::CKKSConjugateOps<BE>,
    for<'a> ScratchArena<'a, BE>: ScratchAvailable + poulpy_core::ScratchArenaTakeCore<'a, BE>,
{
...
pub fn test_conjugate_assign<BE: Backend, F: TestScalar, E: NegacyclicFFT<F>>(ctx: &TestContext<BE, F, E>)
where
    Module<BE>: GLWEAutomorphismDefaults<BE> + GLWEAutomorphism<BE> + GLWEShift<BE> + crate::leveled::api::CKKSConjugateOps<BE>,
    for<'a> ScratchArena<'a, BE>: ScratchAvailable + poulpy_core::ScratchArenaTakeCore<'a, BE>,
{
