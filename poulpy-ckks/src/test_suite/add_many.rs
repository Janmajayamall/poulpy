...
fn build_terms<F: TestScalar>(ctx: &TestContext<impl Backend, F, impl NegacyclicFFT<F>>, n: usize) -> Terms<F> {
...
pub fn test_add_many_aligned<BE: Backend, F: TestScalar, E: NegacyclicFFT<F>>(ctx: &TestContext<BE, F, E>) {
...
pub fn test_add_many_single_smaller_output<BE: Backend, F: TestScalar, E: NegacyclicFFT<F>>(ctx: &TestContext<BE, F, E>) {
    let mut scratch = ctx.alloc_scratch();
...
pub fn test_add_many_unaligned_log_budget<BE: Backend, F: TestScalar, E: NegacyclicFFT<F>>(ctx: &TestContext<BE, F, E>) {
    let mut scratch = ctx.alloc_scratch();
    let (terms, want_re, want_im) = build_terms(ctx, N);
...
pub fn test_add_many_delta_log_delta<BE: Backend, F: TestScalar, E: NegacyclicFFT<F>>(ctx: &TestContext<BE, F, E>) {
    let mut scratch = ctx.alloc_scratch();
...
pub fn test_add_many_smaller_output<BE: Backend, F: TestScalar, E: NegacyclicFFT<F>>(ctx: &TestContext<BE, F, E>) {
    let mut scratch = ctx.alloc_scratch();
    let (terms, want_re, want_im) = build_terms(ctx, N);
    let cts: Vec<_> = terms
        .iter()
