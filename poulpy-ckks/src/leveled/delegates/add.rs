    ...
    for<'a> ScratchArena<'a, BE>: ScratchAvailable + ScratchArenaTakeCore<'a, BE>,
{
    ...
    fn ckks_add_pt_vec_tmp_bytes(&self) -> usize {
        CKKSAddOep::ckks_add_pt_vec_tmp_bytes(self)
    }
    ...
    {
        CKKSAddOep::ckks_add_pt_vec_into(self, dst, a, pt, scratch)
    }
    ...
    where
        ...
        P: GLWEToBackendRef<BE> + LWEInfos + CKKSInfos,
    {
        CKKSAddOep::ckks_add_pt_vec_assign(self, dst, pt, scratch)
    }
    ...
    where
        ...
        P: GLWEToBackendRef<BE> + LWEInfos + CKKSInfos,
    {
        CKKSAddOep::ckks_add_pt_const_into(self, dst, a, dst_coeff, pt, pt_coeff, scratch)
    }
    ...
    where
        ...
        P: GLWEToBackendRef<BE> + LWEInfos + CKKSInfos,
    {
        CKKSAddOep::ckks_add_pt_const_assign(self, dst, dst_coeff, pt, pt_coeff, scratch)
    }
}
    ...
    for<'a> ScratchArena<'a, BE>: ScratchAvailable + ScratchArenaTakeCore<'a, BE>,
{
    ...
    where
        ...
        P: GLWEToBackendRef<BE> + LWEInfos + CKKSInfos,
    {
        self.ckks_add_pt_const_into_unsafe_default(dst, a, dst_coeff, pt, pt_coeff, scratch)
    }
    ...
    where
        ...
        P: GLWEToBackendRef<BE> + LWEInfos + CKKSInfos,
    {
        self.ckks_add_pt_const_assign_unsafe_default(dst, dst_coeff, pt, pt_coeff, scratch)
    }
}
