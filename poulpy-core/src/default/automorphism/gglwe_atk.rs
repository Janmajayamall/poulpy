            ...
            for row in 0..res.dnum().as_usize() {
                for col in 0..cols_in {
                    ...
                    if same_layout {
                        ...
                        let mut res_tmp_view = &mut res_tmp;
                        self.glwe_keyswitch_assign_default(&mut res_tmp_view, key, &mut scratch_iter);
                        ...
                        let mut res_tmp_view = &mut res_tmp;
                        self.glwe_keyswitch_default(&mut res_tmp_view, &tmp_glwe_view, key, &mut scratch_iter);
